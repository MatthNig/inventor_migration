...
source(paste0(getwd(),"/Code/model_training/names_encoding_function.R"))
...
if(special_chars[64] != "ă" | special_chars[35] != "ū"){warnings(
        ...
        print("Read to clean special characters")}
...
names_encoded %>% saveRDS(paste0(mainDir1, "/created data/inventor_encoded.rds"))
pred_dat %>% saveRDS(paste0(mainDir1, "/created data/inventor_raw.rds"))
print("Encoded inventors saved for classification.")
